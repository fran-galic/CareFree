...
```text
<redacted-shared-calendar-email>
```
...
- svi seedani demo psiholozi koriste istu lozinku `<redacted-demo-psychologist-password>`
- svi seedani demo studenti koriste istu lozinku `<redacted-demo-student-password>`
