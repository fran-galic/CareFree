# Psychologist Availability Feature

Ovaj dokument opisuje trenutno implementirano stanje availability funkcionalnosti za psihologe. Interni backend model i dio ruta još koriste naziv `caretaker`, ali korisnički proizvod koristi naziv psiholog.

## Što funkcionalnost radi

Psiholog ručno označava dostupne jednosatne slotove unutar booking prozora:
...
### Psychologist: dohvat vlastite dostupnosti
...
- psiholog ne može mijenjati slot s potvrđenim terminom
...
- calendar invite editor za psihologa
