...
urlpatterns = [
    ...
    path('student/feedback/pending/', StudentPendingFeedbackView.as_view(), name='student-feedback-pending'),
    path('<int:pk>/feedback/', AppointmentFeedbackUpsertView.as_view(), name='appointment-feedback'),
