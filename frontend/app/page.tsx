  ...
  const studentFeatures = [
    {
      ...
      description: "Razgovarajte s AI asistentom u bilo koje doba dana za trenutnu podršku i savjete",
    ...
    },
    {
      ...
      title: "Zakaži termin",
      description: "Jednostavno zakažite termin s licenciranim psihologom koji odgovara vašim potrebama",
      role: "student" as const,
      badge: "S",
    },
    {
      ...
      description: "Vaš identitet ostaje zaštićen - dijelite slobodno bez brige o privatnosti",
      role: "student" as const,
      badge: "S",
    },
  ];
  ...
  const psihologFeatures = [
    {
      ...
      description: "Uploadajte dokumente i specijalizaciju, zatim čekajte na potvrdu profila",
    ...
    },
    {
      ...
      description: "Pregled studenata i sažetaka razgovora koje su vodili s CareFree chatbotom",
      role: "psiholog" as const,
      badge: "P",
    },
    {
      ...
      description: "Postavite svoju dostupnost i prihvaćajte termine kada Vam odgovara",
      role: "psiholog" as const,
      badge: "P",
    },
  ];
    ...
    <div className="hero-section">
      ...
      <div className="role-toggle-container">
        <div className="role-toggle-heading">
          ...
          <p className="role-toggle-description">Personalizirajte iskustvo prema vašim potrebama</p>
        </div>
        <div className="role-toggle-wrapper">
          <button
            onClick={() => setSelectedRole(selectedRole === "student" ? null : "student")}
            className={`role-toggle-option ${selectedRole === "student" ? "active student" : ""}`}
          >
            Student
          </button>
          <button
            onClick={() => setSelectedRole(selectedRole === "psiholog" ? null : "psiholog")}
            className={`role-toggle-option ${selectedRole === "psiholog" ? "active psiholog" : ""}`}
          >
            Psiholog
          </button>
        </div>
