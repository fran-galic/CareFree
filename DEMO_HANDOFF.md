...
- password: `<redacted-demo-psychologist-password>`
...
- password: `<redacted-demo-student-password>`
...
python manage.py create_superuser --email admin@carefree.com --password <redacted-admin-password> --first-name Admin --last-name User
...
- svi demo caretakers opet dobiju shared lozinku:
  - `<redacted-demo-psychologist-password>`
- svi demo studenti opet dobiju shared lozinku:
  - `<redacted-demo-student-password>`
